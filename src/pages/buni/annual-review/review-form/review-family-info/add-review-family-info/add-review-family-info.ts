...
import { FamilyInfo } from '../review-family-info';
import { OrderComm } from '../../../../../../providers/order-comm';
import { Utils } from '../../../../../../providers/Utils';

@Component({
  selector: 'page-add-review-family-info',
  templateUrl: 'add-review-family-info.html',
})
export class AddReviewFamilyInfoPage {
  applygx: string;//人员关系
  userInfo: any;//用户登录信息
  name: string;//姓名
  phone: string; //手机号
