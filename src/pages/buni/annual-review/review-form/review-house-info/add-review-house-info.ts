...
import { HouseInfo } from './review-house-info';
import { OrderComm } from '../../../../../providers/order-comm';
import { Utils } from '../../../../../providers/Utils';
import { StorageService } from '../../../../../providers/localstorage';

@Component({
    selector: 'page-add-review-house-info',
    templateUrl: 'add-review-house-info.html',
})
export class AddReviewHouseInfoPage {
    ...
    ionViewDidLoad() {
        ...
        let info: HouseInfo = this.navParams.get('item');
