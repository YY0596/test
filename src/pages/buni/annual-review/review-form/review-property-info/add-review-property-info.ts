...
import { PropertyInfo } from './review-property-info';
import { Utils } from '../../../../../providers/Utils';
import { StorageService } from '../../../../../providers/localstorage';

@Component({
    selector: 'page-add-review-property-info',
    templateUrl: 'add-review-property-info.html',
})
export class AddReviewPropertyInfoPage {
