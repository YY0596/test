...
import { PropertyInfo } from './change-property-info';
import { Utils } from '../../../../../providers/Utils';
import { StorageService } from '../../../../../providers/localstorage';

@Component({
    selector: 'page-add-change-property-info',
    templateUrl: 'add-change-property-info.html',
})
export class AddChangePropertyInfoPage {
